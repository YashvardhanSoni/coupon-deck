    ...
    <div class="mp-pusher" id="mp-pusher">
      ...
      <div style="background: linear-gradient(90deg, rgba(0,255,68,1) 0%, rgba(0,0,0,1) 50%, rgba(0,0,0,1) 100%); font-family: Times new roman; color: white;">
            <div class="grid_frame">
                <div class="container_grid clearfix">
                    <div class="grid_12">
                        <h2 class="page-title"><h1><b>Brands!!</b></h1></h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div id="container_list_link" class="clearfix link-alpha-link">
                            <div class="grid_3 grp-by-alpha">
                                ...
                                <div class="list-follow">
                                    <div><a href="#">ALT balaji</a></div>
                                    <div><a href="#">Amazon Shoping</a></div>
                                    <div><a href="#">Amazon UPI</a></div>
                                </div>
                            </div>
                            <div class="grid_3 grp-by-alpha">
                                <div class="head-char">G</div>
                                <div class="list-follow">
                                    <div><a href="#">Gaana</a></div>
                                </div>
                            </div>
                            <div class="grid_3 grp-by-alpha">
                                <div class="head-char">O</div>
                                <div class="list-follow">

                                    <div><a href="#">OYO</a></div>

                                </div>
                            </div>
                            <div class="grid_3 grp-by-alpha">
                                <div class="head-char">M</div>
                                <div class="list-follow">

                                    <div><a href="#">Myntra</a></div>

                                </div>
                            </div>
                            <div class="grid_3 grp-by-alpha">
                                <div class="head-char">N</div>
                                <div class="list-follow">

                                    <div><a href="#">Newchic</a></div>

                                </div>
                            </div>
                            <div class="grid_3 grp-by-alpha">
                                <div class="head-char">T</div>
                                <div class="list-follow">

                                    <div><a href="#">Testbook</a></div>

                                </div>
                            </div>
                            <div class="grid_3 grp-by-alpha">
                                <div class="head-char">Z</div>
                                <div class="list-follow">

                                    <div><a href="#">Zee5</a></div>
                                </div>
                            </div>
