                ...
                <div class="layout-2cols clearfix">
                    <div class="grid_8 content">
                        <div class="mod-coupons-code">
                            <div class="wrap-list">
                                <h1><a style="background-color:rgba(5,167,201,1); color:white; border-radius:25px; text-decoration: none;">&nbsp Amazon Offers &nbsp<br></a></h1>
                                <div class="coupons-code-item right-action flex">
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                <span class="ver_hold"></span>
                                                <a href="#" class="ver_container"><img src="images/br/amazon.png" alt="Amazon"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="right-content flex-body">
                                        ...
                                        <div class="popup"
                                        aria-modal="true">
                                          <center><h2>OFFER<br>DESCRIPTION- 1</h2></center>
                                        ...
                                        <br><br><br><a href="https://www.amazon.in/gp/bestsellers/hpc/ref=zg_bs_nav_0?&_encoding=UTF8&tag=mtrackmmipl-21&linkCode=ur2&linkId=814ca163f1c0234f2b420bbd1244f2d1&camp=3638&creative=24630" target="_blank">Redirect to Offer Site</a></center>
                                        </div>
                                    </div>
                                ...
                                <div class="coupons-code-item right-action flex">
                                    ...
                                    <div class="right-content flex-body">
                                        ...
                                        <div class="popup"
                                        aria-modal="true">
                                          <center><h2>OFFER<br>DESCRIPTION- 2</h2></center>
                                          <a class="close" href="#">&times;</a>
                                          <div class="content">
                                            SkinKraft <br>
                                            <b>Offer details: </b><br>
                                        ...
                                        <div class="bottom-action">
                                        <br><br><br><a href="">Redirect to Offer Site</a></center>
                                        </div>
                                    </div>
                                </div><!--end: .coupons-code-item -->
                                <div class="coupons-code-item right-action flex">
                                    ...
                                    <div class="right-content flex-body">
                                        ...
                                        <div class="popup"
                                        aria-modal="true">
                                          <center><h2>OFFER<br>DESCRIPTION- 3</h2></center>
                                          <a class="close" href="#">&times;</a>
                                          <div class="content">
                                            SkinKraft <br>
                                            <b>Offer details: </b><br>
                                ...
                                <div class="coupons-code-item right-action flex">
                                    ...
                                    <div class="right-content flex-body">
                                        ...
                                        <div class="popup"
                                        aria-modal="true">
                                          <center><h2>OFFER<br>DESCRIPTION- 4</h2></center>
                                          <a class="close" href="#">&times;</a>
                                          <div class="content">
                                            SkinKraft <br>
                                            <b>Offer details: </b><br>
