...
if(isset($_POST["submit"]))
{
    ...
    $check = mysqli_query($db,"insert into indpop(fname,images) values('$_POST[fname]','$dst_db')");  // executing insert query
...
$records = mysqli_query($coupondeck,"select * from indpop"); // fetch data from database
