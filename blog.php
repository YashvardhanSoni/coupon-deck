							...
							<article id="content">
								...
								<div class="post-block">
									<div class="img-holder">
										<a href="benefits_of_discount_coupon.php"><img src="blog/blog1b.jpg" alt="image description" class="img-responsive"></a>
										<time class="time text-center" datetime="2021-09-15 20:00">15 <span>Sep</span></time>
									</div>
									<div class="txt-holder">
										...
										<a href="benefits_of_discount_coupon.php" target="_blank" class="btn-primary text-center text-uppercase">read more</a>
									</div>
								</div>
								<!-- post block of the page -->
								<div class="post-block">
									<div class="img-holder">
										<a href="discount_coupons.php"><img src="blog/blog2b.jpg" alt="image description" class="img-responsive"></a>
										<time class="time text-center" datetime="2021-09-16 20:00">16 <span>Sep</span></time>
									</div>
									<div class="txt-holder">
										...
										<a href="discount_coupons.php" target="_blank" class="btn-primary text-center text-uppercase">read more</a>
									</div>
								</div>
